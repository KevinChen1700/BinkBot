...
class Window(Frame):
    ...
    def init_window(self):
        ...
        sdanceButton = Button(self, text=" Single Dance ", relief=RIDGE, bg="black", fg="white",
                              command=self.client_sdance)
        sdanceButton.place(x=10, y=20)

        ldanceButton = Button(self, text="  Line Dance  ", relief=RIDGE, bg="black", fg="white",
                              command=self.client_ldance)
        ...
        blueButton = Button(self, text="      Blue Bar     ", relief=RIDGE, bg="black", fg="white",
                            command=self.client_blue)
        blueButton.place(x=270, y=20)

        manualButton = Button(self, text=" Manual  mode ", relief=RIDGE, bg="black", fg="white",
                              command=self.manual_mode)
        manualButton.place(x=270, y=70)

        stad1Button = Button(self, text="Eindhoven", relief=RIDGE, bg="black", fg="white", command=self.eindhoven)
        stad1Button.place(x=65, y=120)

        stad2Button = Button(self, text="Eibergen", relief=RIDGE, bg="black", fg="white", command=self.eibergen)
        stad2Button.place(x=135, y=120)

        stad3Button = Button(self, text="Barneveld", relief=RIDGE, bg="black", fg="white", command=self.barneveld)
        stad3Button.place(x=195, y=120)

        stad4Button = Button(self, text="Duckstad", relief=RIDGE, bg="black", fg="white", command=self.duckstad)
        stad4Button.place(x=260, y=120)
    ...
    def eindhoven(self):
        lbl.config(text="eggTelligence start at Eindhoven")
        self.lastPressed = "eindhoven"

    def eibergen(self):
        lbl.config(text="eggTelligence start at Eibergen")
        self.lastPressed = "eibergen"

    def barneveld(self):
        lbl.config(text="eggTelligence start at Barneveld")
        self.lastPressed = "barneveld"

    def duckstad(self):
        lbl.config(text="eggTelligence start at Duckstad")
        self.lastPressed = "duckstad"
